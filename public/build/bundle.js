...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$8, 21, 4, 412);
    			attr_dev(header, "class", "svelte-1h1h9hx");
    			add_location(header, file$8, 20, 0, 398);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (/*mode*/ ctx[1] + " " + /*color*/ ctx[3] + " svelte-9ib8ag"));
    			button.disabled = /*disabled*/ ctx[4];
    			add_location(button, file$7, 92, 0, 1836);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*mode, color*/ 10 && button_class_value !== (button_class_value = "" + (/*mode*/ ctx[1] + " " + /*color*/ ctx[3] + " svelte-9ib8ag"))) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$7, 88, 0, 1790);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["type", "caption", "mode", "href", "color", "disabled"];
    	...
    	return [type, mode, href, color, disabled, caption, $$scope, slots, click_handler];
    }
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*caption*/ ctx[5] === undefined && !("caption" in props)) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			if (default_slot) default_slot.c();
    			attr_dev(span, "class", "svelte-10czmgf");
    			add_location(span, file$6, 13, 0, 296);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(91:6) <Button href=\\\"mailto:{email}\\\">",
    		ctx
    	});
    ...
    // (92:6) <Button           type="button"           mode="outline"           color = {isFav ? null : 'success'}          on:click={() => dispatch('toggleFavorite', id)}        >
    function create_default_slot_1$1(ctx) {
    	let t_value = (/*isFav*/ ctx[7] ? "Unavorite" : "Favorite") + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isFav*/ 128 && t_value !== (t_value = (/*isFav*/ ctx[7] ? "Unavorite" : "Favorite") + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(92:6) <Button           type=\\\"button\\\"           mode=\\\"outline\\\"           color = {isFav ? null : 'success'}          on:click={() => dispatch('toggleFavorite', id)}        >",
    		ctx
    	});
    ...
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(98:6) <Button type=\\\"button\\\">",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 21, 0, 320);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "type", /*controlType*/ ctx[1]);
    			attr_dev(input, "id", /*id*/ ctx[2]);
    			input.value = /*value*/ ctx[0];
    			attr_dev(input, "class", "svelte-v2evya");
    			toggle_class(input, "invalid", !/*valid*/ ctx[5] && /*touched*/ ctx[7]);
    			add_location(input, file$3, 60, 6, 1143);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-v2evya");
    			toggle_class(textarea, "invalid", !/*valid*/ ctx[5] && /*touched*/ ctx[7]);
    			add_location(textarea, file$3, 58, 6, 1011);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:4) {#if controlType === \\\"textarea\\\"}",
    		ctx
    	});
    ...
    // (63:4) {#if validationMessage && !valid && touched}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "error-message svelte-v2evya");
    			add_location(p, file$3, 63, 6, 1338);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(63:4) {#if validationMessage && !valid && touched}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let if_block1 = /*validationMessage*/ ctx[6] && !/*valid*/ ctx[5] && /*touched*/ ctx[7] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-v2evya");
    			add_location(label_1, file$3, 56, 4, 932);
    			attr_dev(div, "class", "form-control svelte-v2evya");
    			add_location(div, file$3, 55, 0, 900);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*validationMessage*/ ctx[6] && !/*valid*/ ctx[5] && /*touched*/ ctx[7]) {
    				if (if_block1) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let touched = false;
    	const writable_props = ["controlType", "id", "label", "value", "rows", "valid", "validationMessage"];
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 60, 0, 1168);
    			attr_dev(h1, "class", "svelte-1n7jjgg");
    			add_location(h1, file$2, 62, 4, 1246);
    			attr_dev(div1, "class", "content svelte-1n7jjgg");
    			add_location(div1, file$2, 63, 4, 1268);
    			attr_dev(footer, "class", "svelte-1n7jjgg");
    			add_location(footer, file$2, 66, 4, 1325);
    			attr_dev(div2, "class", "modal svelte-1n7jjgg");
    			add_location(div2, file$2, 61, 0, 1221);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function isEmailValid(val) {
        return new RegExp("^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$").test(val);
    }

    /* src\MeetUp\EditMeetup.svelte generated by Svelte v3.37.0 */
    const file$1 = "src\\MeetUp\\EditMeetup.svelte";

    // (53:0) <Modal title="Edit Meetup" on:cancel>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 53, 4, 1344);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*imgUrlValid*/ 2048) textinput3_changes.valid = /*imgUrlValid*/ ctx[11];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(53:0) <Modal title=\\\"Edit Meetup\\\" on:cancel>",
    		ctx
    	});
    ...
    // (112:8) <Button type="button" on:click={submitForm} disabled="{!formIsValid}">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(112:8) <Button type=\\\"button\\\" on:click={submitForm} disabled=\\\"{!formIsValid}\\\">",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 109, 4, 3282);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, formIsValid, descriptionValid, description, emailValid, email, imgUrlValid, imgUrl, addressValid, address, subtitleValid, subtitle, titleValid, title*/ 8396799) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("imgUrlValid" in $$props) $$invalidate(11, imgUrlValid = $$props.imgUrlValid);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*email*/ 8) {
    			$$invalidate(9, emailValid = isEmailValid(email));
    		}
    		...
    		if ($$self.$$.dirty & /*imgUrl*/ 32) {
    			$$invalidate(11, imgUrlValid = !isEmpty(imgUrl));
    		}

    		if ($$self.$$.dirty & /*titleValid, subtitleValid, descriptionValid, emailValid, addressValid, imgUrlValid*/ 4032) {
    			$$invalidate(12, formIsValid = titleValid && subtitleValid && descriptionValid && emailValid && addressValid && imgUrlValid);
    		}
    	};
    ...
    function create_if_block(ctx) {
    	...
    	editmeetup.$on("cancel", /*cancelModal*/ ctx[4]);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "meetup-controls svelte-98sazn");
    			add_location(div, file, 76, 4, 2387);
    			attr_dev(main, "class", "svelte-98sazn");
    			add_location(main, file, 75, 0, 2375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [editMode, meetups, addMeetup, toggleFavorite, cancelModal, click_handler];
    }
